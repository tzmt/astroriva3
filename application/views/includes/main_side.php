    ...
    <hr>       
        <div class="row m-t-20">
            ...
            <div class="col-xs-6" style="margin-bottom: 10px">
                <a href="<?php echo base_url(); ?>shop/details/<?php echo $q1->id; ?>/<?php echo strtolower(str_replace(' ', '-', $q1->name)); ?>"><img src="<?php echo URL; ?>assets/products/<?php echo $image; ?>" class=" center-block" width="100%" height="130px"/></a>
            </div>
            <?php } ?>
        </div>   

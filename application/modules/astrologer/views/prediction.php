        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="m-t-20 bg-white breadcrumb text-center">
                    ...
                    <li>
                        <span class="active text-primary font13">Add Prediction</span>
                    </li>
                </ul>
            </div>
        </div>
							...
							<div class="row">
								...
								<div class="col-md-9">
									<table class="table table-bordered">
										...
										<?php foreach($prediction as $key=> $tip){ ?>
										<tr>
											<td><?php echo $key+1; ?></td>
											<td><?php echo date("d-m-Y",strtotime($tip->date_from))." to ". date("d-m-Y",strtotime($tip->date_to)); ?></td>											
											<td><?php echo $tip->description; ?></td>
											<td><a href="<?php echo base_url(); ?>astrologer/delete_prediction/<?php echo $tip->id; ?>/<?php echo $tip->image; ?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
										</tr>	
										<?php } ?>
									</table>
								</div>													

        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="m-t-20 bg-white breadcrumb text-center">
                    ...
                    <li>
                        <span class="active text-primary font13">Account Upgrade</span>
                    </li>
                </ul>
            </div>
        </div>
							...
							<div class="col-md-12">
								...
								<form id="comment-form" class="row" name="comment-form" method="post" action="">
									...
									<div class="col-md-12">	
										...
										<?php
										if(isset($data->astrology_id) && $data->astrology_id != "")
										{?>
											<div style="padding:10px;background:#c1f8c6;color:green;margin-bottom:10px;text-align:center;border:1px solid green">You have already applied at <?php echo date("d-m-Y g:i:s a",strtotime($data->time)); ?>.</div>
										<?php }
										?>

										<div class="form-group">
											<label>Membership Plan</label>											
											<select name="membership" class="form-control" required="required">
												<option value="">----SELECT---</option>
												<option value="1">Premium</option>
												<option value="2">Panneled</option>
											</select>

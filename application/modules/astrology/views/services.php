        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="m-t-20 bg-white breadcrumb text-center">
                    ...
                    <li>
                        <span class="active text-primary font13">Services</span>
                    </li>
                </ul>
            </div>
        </div>
				...
				<div class="row text-center">
					...
					<div class="col-md-4" style="border-radius: 5px;padding:5px;">
						...
						<div class="entry-body">
							...
							<p><a href="<?php echo base_url(); ?>services/<?php echo $dat->id; ?>/<?php echo strtolower(str_replace(" ", "-", $dat->name)); ?>"><button class="btn btn-primary text-center">Read More</button></a></p>
						</div>
					</div>
					<?php } ?>
				</div>

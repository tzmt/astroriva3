					...
					<table class="table table-striped" id="responsiveTable">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $this->rashi_model->getAstrologerNameFromId($prid->astrologer_id); ?></td>
								...
								<td><a href="#simpleModal<?php echo $prid->id; ?>" role="button" data-toggle="modal"><span class="label label-success">View</span></a>
								...
								<div class="modal-dialog">
									<div class="modal-content">
									    ...
									    <div class="modal-body">
									        ...
									        <p><strong>Astrologer: </strong><?php echo $this->rashi_model->getAstrologerNameFromId($prid->astrologer_id); ?></p>

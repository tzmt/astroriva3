				...
				?>				
					<div class="col-md-8">						
						<div class="panel panel-default">
							<div class="panel-heading">Add Bastu</div>
							<div class="panel-body">
								<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>bastu/add_bastu/" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											<input type="text" name="title" class="form-control input-sm" placeholder="Enter your title" required>
									...
									<div class="form-group">
										<div class="col-lg-offset-2 col-lg-10">
											<button type="submit" class="btn btn-success btn-sm">Add Bastu</button>
										</div><!-- /.col -->
									</div><!-- /form-group -->
								</form>
							</div>

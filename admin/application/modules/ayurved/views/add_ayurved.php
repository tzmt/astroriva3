...
<div id="main-container">
			<div id="breadcrumb">
				<ul class="breadcrumb">
					 ...
					 <li class="active">Add Ayurved</li>	 
				</ul>
			</div><!-- breadcrumb -->
				...
				?>				
					<div class="col-md-8">						
						<div class="panel panel-default">
							<div class="panel-heading">Add Ayurved</div>
							<div class="panel-body">
								<form class="form-horizontal" method="post" action="<?php echo base_url(); ?>ayurved/add/" enctype="multipart/form-data">
																	
									<div class="form-group">
										<label for="inputEmail1" class="col-lg-2 control-label">Topic</label>
										<div class="col-lg-10">
											<input type="text" name="topic" class="form-control input-sm" id="inputEmail1" placeholder="Enter your topic" required>
									...
									<div class="form-group">
										<div class="col-lg-offset-2 col-lg-10">
											<button type="submit" class="btn btn-success btn-sm">Add Ayurved</button>
										</div><!-- /.col -->
									</div><!-- /form-group -->
								</form>
							</div>

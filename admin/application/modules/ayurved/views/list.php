...
<div id="main-container">
			<div id="breadcrumb">
				<ul class="breadcrumb">
					 <li><i class="fa fa-home"></i><a href="index-2.html"> Ayurved Management</a></li>
					 <li class="active">Ayurved List</li>	 
				</ul>
			</div><!-- breadcrumb -->
					...
					<table class="table table-striped" id="responsiveTable">
						...
						<tbody>
							...
							<tr>
								...
								<td><img src="<?php echo SITE_URL; ?>assets/ayurved/<?php echo $prid->image; ?>" width="50px" /></td>
								...
								<div class="modal-dialog">
									<div class="modal-content">
									    ...
									    <div class="modal-body">
									        <p><img src="<?php echo SITE_URL; ?>assets/ayurved/<?php echo $prid->image; ?>" width="100px" /></p>
						...
						<div class="modal fade" id="simpleEditModal<?php echo $prid->id; ?>">
								...
								<div class="modal-content">
								    ...
								    <div class="modal-body">
								       <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>ayurved/lists/" enctype="multipart/form-data">
									...
									<div class="form-group">
										...
										<div class="col-lg-10">
											...
											<p><img src="<?php echo SITE_URL; ?>assets/ayurved/<?php echo $prid->image; ?>" width="50px" /></p>
						...
						<div class="modal fade" id="deleteModal<?php echo $prid->id; ?>">
								<div class="modal-dialog">
									<div class="modal-content">
						  				<div class="modal-header">
						    				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
											<h4>Delete Ayurved</h4>
						  				</div>
									    <div class="modal-body">
									        <p>Are you sure you want to delete this item?</p>	        
									    </div>
									    <div class="modal-footer">
									        <a href="<?php echo base_url(); ?>ayurved/delete_ayurved/<?php echo $prid->id; ?>/<?php echo $prid->image; ?>"><button class="btn btn-sm btn-success" aria-hidden="true">Yes</button></a>	

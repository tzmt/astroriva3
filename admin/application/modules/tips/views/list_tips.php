...
<div id="main-container">
			<div id="breadcrumb">
				<ul class="breadcrumb">
					 <li><i class="fa fa-home"></i><a href="index-2.html"> Tips Management</a></li>
					 <li class="active">Tips List</li>	 
				</ul>
			</div><!-- breadcrumb -->
					...
					<table class="table table-striped" id="responsiveTable">
						...
						<tbody>
							...
							<tr>
								...
								<td><?php echo $this->tips_model->getRashiName($prid->rashi_id); ?></td>
								<td><?php if($prid->type == 1) echo "Admin"; else echo $this->tips_model->getAstrologerNameFromId($prid->astrologers_id); ?></td>
								<td><img src="<?php echo SITE_URL; ?>assets/tips/<?php echo $prid->image; ?>" width="100px" /></td>
								...
								<div class="modal-dialog">
									<div class="modal-content">
									    ...
									    <div class="modal-body">
									        <p><img src="<?php echo SITE_URL; ?>assets/tips/<?php echo $prid->image; ?>" width="100%" /></p>
									        <p><strong>Rashi: </strong><?php echo $this->tips_model->getRashiName($prid->rashi_id); ?></p>
									        <p><strong>Astrologer: </strong><?php if($prid->type == 1) echo "Admin"; else echo $this->tips_model->getAstrologerNameFromId($prid->astrologers_id); ?></p>
								    ...
								    <div class="modal-body">
								       <form class="form-horizontal" method="POST" action="<?php echo base_url(); ?>tips/lists/" enctype="multipart/form-data">
											...
											<div class="form-group">
												...
												<img src="<?php echo SITE_URL; ?>assets/tips/<?php echo $prid->image; ?>" width="100px" style="margin-top: 13px;margin-left: 17px;"/>
											</div><!-- /form-group -->
						...
						<div class="modal fade" id="deleteModal<?php echo $prid->id; ?>">
								<div class="modal-dialog">
									<div class="modal-content">
									    ...
									    <div class="modal-footer">
									        <a href="<?php echo base_url(); ?>tips/delete_tips/<?php echo $prid->id; ?>"><button class="btn btn-sm btn-success" aria-hidden="true">Yes</button></a>	
